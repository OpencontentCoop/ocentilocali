...
<div class="attribute-header">
    <h1 class="long">Accedi al portale del territorio</h1>
</div>

{if $User:warning.bad_login}
<div class="warning abs">
{"A valid username and password is required to login."|i18n("design/ezwebin/user/login")}
</div>
{else}

{if $site_access.allowed|not}
<div class="warning abs">
{"You are not allowed to access %1."|i18n("design/ezwebin/user/login",,array($site_access.name))}
</div>
{/if}
...
<div class="block">
<label for="id1">Nome utente o indirizzo email</label><div class="labelbreak"></div>
...
<p class="forgotpassword"><a href={'/user/forgotpassword'|ezurl}>{'Forgot your password?'|i18n( 'design/ezwebin/user/login' )}</a></p>
