...
<div class="global-view-full content-view-full">
    ...
    {def $specials = fetch( content, node, hash( 'node_id', array( 400337, 400338 ) ) )}
    <div class="servizio-top">
        {foreach $specials as $child}
        <h2>{node_view_gui view='toolline' content_node=$child.object.main_node}</h2>
        {/foreach}
    </div>
