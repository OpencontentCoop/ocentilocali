		...
		<li id="menu-aree-tematiche" class="lastli aree-tematiche">
            <div>
                ...
                <div class="secondlevel">
                    <div class="secondlevel-design float-break">
                        <ul>
	...
	{else}		
		...
		{foreach $top_menu_items as $key => $item}
            {if $item.can_read}
                ...
                {if $item|is_comuni_folder()}
                    <div id="menu-comuni" class="secondlevel">
                        <div class="secondlevel-design float-break">
                            ...
                            <ul class="comune">
                                <li id="node_id_{$item2.node_id}" class="count-{$level_2_items|count()} item-{$key|inc()}">
                                    <h2>
                                    ...
                                    <ul>
                                        {foreach $links as $name => $url}
                                            <li>
                                                <a title="Visualizza {$name} del comune di {$item2.name|wash()}" href="{concat( $item2.url, $url )|ezurl(no)}" {if or( eq( $ui_context, 'browse' ), $pagedata.is_edit )} onclick="return false;"{/if}>
                                            {$name|wash()}
                                        </a>
                                            </li>
                                        {/foreach}
                    ...
                    <div class="secondlevel">
                        <div class="secondlevel-design float-break">
                            ...
                            <div class="menu-preview">
                                {node_view_gui content_node=$item view=menu_preview}
                            </div>
                        </div>
                    </div>
                {/if}				
