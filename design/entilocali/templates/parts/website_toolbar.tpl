...
{if or( $content_object.can_edit, $content_object.can_move, $content_object.can_remove, $can_manage_location )}
...
{def $siteaccess_part = $access_type.name|explode( '_' )
     $backend_siteaccess = concat( $siteaccess_part[0], '_backend' )}
{if has_access_to_limitation('user', 'login', hash('SiteAccess', $backend_siteaccess)) }
