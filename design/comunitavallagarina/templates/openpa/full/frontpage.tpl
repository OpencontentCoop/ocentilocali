...
<div class="content-view-full{if $node.node_id|eq(ezini('NodeSettings','RootNode','content.ini'))} custom-homepage{/if}">
...
{if $node.node_id|eq(ezini('NodeSettings','RootNode','content.ini'))}
    {ezpagedata_append( 'extra_template_list', array( 'background_carousel.tpl' ) )}
{/if}